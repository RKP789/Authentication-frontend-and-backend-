        ...
        <div className='w-full h-full flex justify-center items-center'>
            <div className='p-4 border border-white flex flex-col justify-center items-center rounded-lg text-white'>
                ...
                <form className='flex flex-col gap-4'>
                    ...
                    <input onChange={(e) => {setUsername(e.target.value)}} className='px-2 py-1 w-[18rem] outline-none border border-gray-400 rounded-md focus:border-gray-300' type='text' placeholder='Username' name='username' value={username}/>
                    ...
                    <div className='flex justify-center'>
                        <div className='bg-gradient-to-r from-purple-500 to-red-500 p-1 rounded-lg mt-2 active:scale-95'>
                            <button onClick={submitHandler} className='text-xl bg-gray-400 rounded-md px-2 py-1 hover:bg-transparent'>Sign Up</button>
                        </div>
                    </div>
                </form>
            </div>
